...
namespace Core
{
    namespace ScalarFiniteElements
    {
        ...
        {
            public class LinearRectangularFiniteElementWithNumInteg : IFiniteElementWithNumericIntegration<Vector2D, double>
            {
                ...
                public IMasterElement<Vector2D, double> MasterElement { get; }
