...
namespace Core
{
    ...
    {
        public Material(bool isVolume, bool is1, bool is2, Func<Vector3D, double> lambda, Func<Vector3D, double> sigma, Func<Vector3D, double> epsilon, Func<Vector3D, double> mu, Func<Vector3D, double, double> theta, Func<Vector3D, double, Vector3D> htheta, Func<Vector3D, double, double> ug, Func<Vector3D, double, Vector3D> ag, Func<Vector3D, double, double> f, Func<Vector3D, double, Vector3D> fv)
        {
            IsVolume = isVolume;
            Is1 = is1;
            Is2 = is2;
